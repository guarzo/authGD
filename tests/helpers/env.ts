...
export const BASE_ENV = {
  ...
  SYNC_MODE: "live",
  // `Record<string, string>`, not `NodeJS.ProcessEnv`: Next's ambient types
  // make NODE_ENV a required member, and this block deliberately doesn't set
  // it — the runner owns NODE_ENV. The check we want here is "every value is a
  // string", which this gives.
